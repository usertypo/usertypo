...
const ALL_LANGUAGES = [
    ...
    { file: "code_abap", name: "ABAP", category: "code" },
    { file: "code_abap_1k", name: "ABAP 1k", category: "code" },
    { file: "code_arduino", name: "Arduino", category: "code" },
    { file: "code_assembly", name: "Assembly", category: "code" },
    { file: "code_bash", name: "Bash", category: "code" },
    { file: "code_brainfck", name: "Brainfck", category: "code" },
    { file: "code_c", name: "C", category: "code" },
    { file: "code_c++", name: "C++", category: "code" },
    { file: "code_clojure", name: "Clojure", category: "code" },
    { file: "code_cobol", name: "COBOL", category: "code" },
    { file: "code_common_lisp", name: "Common Lisp", category: "code" },
    { file: "code_csharp", name: "C#", category: "code" },
    { file: "code_css", name: "CSS", category: "code" },
    { file: "code_cuda", name: "CUDA", category: "code" },
    ...
    { file: "code_gdscript", name: "GDScript", category: "code" },
    { file: "code_gdscript_2", name: "GDScript 2", category: "code" },
    { file: "code_gleam", name: "Gleam", category: "code" },
    ...
    { file: "code_javascript_1k", name: "Javascript 1k", category: "code" },
    { file: "code_javascript_react", name: "Javascript React", category: "code" },
    { file: "code_jule", name: "Jule", category: "code" },
    { file: "code_julia", name: "Julia", category: "code" },
    { file: "code_kotlin", name: "Kotlin", category: "code" },
    { file: "code_latex", name: "Latex", category: "code" },
    { file: "code_lua", name: "Lua", category: "code" },
    { file: "code_luau", name: "Luau", category: "code" },
    { file: "code_matlab", name: "Matlab", category: "code" },
    { file: "code_nim", name: "Nim", category: "code" },
    { file: "code_nix", name: "Nix", category: "code" },
    { file: "code_ocaml", name: "OCaml", category: "code" },
    { file: "code_odin", name: "Odin", category: "code" },
    { file: "code_ook", name: "Ook", category: "code" },
    { file: "code_opencl", name: "OpenCL", category: "code" },
    ...
    { file: "code_python_1k", name: "Python 1k", category: "code" },
    { file: "code_python_2k", name: "Python 2k", category: "code" },
    { file: "code_python_5k", name: "Python 5k", category: "code" },
    { file: "code_r", name: "R", category: "code" },
    { file: "code_r_2k", name: "R 2k", category: "code" },
    { file: "code_rockstar", name: "Rockstar", category: "code" },
    ...
    { file: "code_systemverilog", name: "Systemverilog", category: "code" },
    { file: "code_typescript", name: "Typescript", category: "code" },
    { file: "code_typst", name: "Typst", category: "code" },
    { file: "code_v", name: "V", category: "code" },
    { file: "code_vim", name: "Vim", category: "code" },
    { file: "code_vimscript", name: "Vimscript", category: "code" },
    { file: "code_visual_basic", name: "Visual Basic", category: "code" },
    { file: "code_yoptascript", name: "Yoptascript", category: "code" },
    ...
    { file: "docker_file", name: "Docker File", category: "special" },
    ...
    { file: "git", name: "Git", category: "special" },
    ...
    { file: "klingon", name: "Klingon", category: "special" },
    { file: "klingon_1k", name: "Klingon 1k", category: "special" },
    ...
    { file: "league_of_legends", name: "League Of Legends", category: "special" },
    ...
    { file: "lojban_cmavo", name: "Lojban Cmavo", category: "special" },
    { file: "lojban_gismu", name: "Lojban Gismu", category: "special" },
    { file: "lorem_ipsum", name: "Lorem Ipsum", category: "special" },
    ...
    { file: "pig_latin", name: "Pig Latin", category: "special" },
    ...
    { file: "quenya", name: "Quenya", category: "special" },
    ...
    { file: "toki_pona", name: "Toki Pona", category: "special" },
    { file: "toki_pona_ku_lili", name: "Toki Pona Ku Lili", category: "special" },
    { file: "toki_pona_ku_suli", name: "Toki Pona Ku Suli", category: "special" },
    ...
    { file: "twitch_emotes", name: "Twitch Emotes", category: "special" },
    { file: "typing_of_the_dead", name: "Typing Of The Dead", category: "special" },
    ...
    { file: "viossa", name: "Viossa", category: "special" },
    { file: "viossa_njutro", name: "Viossa Njutro", category: "special" },
    { file: "welsh", name: "Welsh", category: "natural" },
    { file: "welsh_1k", name: "Welsh 1k", category: "natural" },
    { file: "wordle", name: "Wordle", category: "special" },
    { file: "wordle_1k", name: "Wordle 1k", category: "special" },
